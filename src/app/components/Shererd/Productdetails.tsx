...
const Productdetails: FC<{ item: oneProductType }> = ({ item }) => {
  ...
  return (
    <Wreper>
      ...
      <main>
        <div className='md:flex sm:flex-wrap mt-10'>
        <div className='flex gap-2 pr-3'>
          <div>
          <Image src={urlFor(item.image).url()}width={100} height={100} alt={''} />
              
              </div>
            <div>
            <Image src={urlFor(item.image).url()}width={400} height={400} alt={''} />
...
<Quantity product={item} />
        ...
        <div className='mt-10'>
          ...
          <div className='text-gray-600 '>
            <div className='md:flex sm:flex-wrap sm:mx-6  px-2 py-4'>
              <div className='w-80'>
                <h3 className='font-semibold '>PRODUCT DETAILS :</h3>
              </div>
              <p  className=' sm:px-8'>
                nLorem ipsum dolor sit amet, consectetur
                 adipiscing elit, sed do eiusmod tempor incididunt 
                 ut labore et dolore magna aliqua. Ut enim ad minim 
                 </p>
            </div>
            <div className='md:flex sm:flex-wrap px-2 py-8'>
              <div className='w-80'>
                <h3 className='font-semibold '>PRODUCT CARE :</h3>
              </div>
              <ul className='pl-3 list-disc font-semibold text-gray-900 sm:px-8'>
