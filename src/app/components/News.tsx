...
function News() {
  return (
    ...
    <div className="flex justify-center items-center min-h-screen ">
      ...
      <div className="bg-white p-1 relative w-full max-w-lg ">
        ...
        <form className="flex md:gap-4 sm:gap-1 pt-10 sm:w-20" >
          <input
            className="bg-white rounded px-4 py-2 mb-4 border"
            type="email"
            placeholder="Enter your email address"
          />
          <button className="bg-blue-700 text-white rounded-lg px-4 h-12 ">
            Get Started
          </button>
        </form>
